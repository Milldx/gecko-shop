...
const form = reactive({
  ...
  pageCategory: product.isSale ? 'sale' : product.isNew ? 'new' : product.isCollection ? 'collection' : 'none',
})
          ...
          <div class="form-group">
            ...
            <div class="radio-group">
              <label class="radio-label">
                <input type="radio" v-model="form.pageCategory" value="none" class="radio-input" />
                <span>Основной каталог</span>
              </label>
              <label class="radio-label">
                <input type="radio" v-model="form.pageCategory" value="new" class="radio-input" />
                <span>Новинки</span>
              </label>
              <label class="radio-label">
                <input type="radio" v-model="form.pageCategory" value="collection" class="radio-input" />
                <span>Коллекция</span>
              </label>
              <label class="radio-label">
                <input type="radio" v-model="form.pageCategory" value="sale" class="radio-input" />
                <span>SALE</span>
              </label>
            </div>
          </div>
...
.check-label-inline { display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 12px; }
